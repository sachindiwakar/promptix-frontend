...
const BlogTitles = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true);
      const prompt = `Generate 5 SEO-friendly and catchy blog titles for the keyword ${input}. Blog category/type: ${selectedCategory}.Return only the titles in a numbered list.`;
